...
const HostSpot = () => {
          ...
          <div className="step0-seperate">
            <div className="step0-individual-wrap">
              <div className="step0-individual step0-1">
                ...
                <img className="step0-img" src="https://imgur.com/6BpM4wC.png" alt="host spot" />
              </div>
              <div className="step0-individual">
                ...
                <img className="step0-img-1" src="https://imgur.com/8igNnZe.png" alt="host spot" />
              </div>
            </div>
          </div>
        </div >
    ...
    return (
      <div className="step1-wrapper">
        ...
        <div className="step1-right">
          <img className="step1-img-1" src="https://imgur.com/qScRuLe.png" alt="host spot" />
        </div>
  ...
  const centerPoint = { lat: lat ? lat : 37.7749, lng: lng ? lng : -122.4194 }
                ...
                <div className="autocomplete-dropdown-container">
                  {loading &&
                    <div className="autocomplete-loading">
                      <img className="autocomplete-loading-img" src="https://imgur.com/gIENxaI.gif" alt="host spot" />
                    </div>}
  ...
  const spotPage5 = () => {
    return (
      <div className="step1-wrapper">
        ...
        <div className="step1-right">
          <img className="step1-img-1" src="https://imgur.com/JyXItmZ.png" alt="host spot" />
        </div>
        <div className="step0-footer step1-footer">
        ...
        <div className="step2">
          ...
          <div className="step6-input-wrapper">
            <div className="amenities-container">
              ...
              <img className="amenities-img" src="https://imgur.com/fHVWE9K.png" alt="host spot" />
            </div>
            <div className="amenities-container">
              ...
              <img className="amenities-img" src="https://imgur.com/csXC3RL.png" alt="host spot" />
            </div>
            <div className="amenities-container">
              ...
              <img className="amenities-img" src="https://imgur.com/uwD4CGY.png" alt="host spot" />
            </div>
            <div className="amenities-container">
              ...
              <img className="amenities-img" src="https://imgur.com/Xluxljd.png" alt="host spot" />
            </div>
            <div className="amenities-container">
              ...
              <img className="amenities-img" src="https://imgur.com/z2lA5yX.png" alt="host spot" />
            </div>
            <div className="amenities-container">
              ...
              <img className="amenities-img" src="https://imgur.com/nARtwQZ.png" alt="host spot" />
            </div>
            <div className="amenities-container">
              ...
              <img className="amenities-img" src="https://imgur.com/cHR1Rxx.png" alt="host spot" />
            </div>
            <div className="amenities-container">
              ...
              <img className="amenities-img" src="https://imgur.com/7iFsb5g.png" alt="host spot" />
            </div>
          </div>
          <div className="step0-footer">
    ...
    return (
      <div className="step7-wrapper">
        ...
        <div className="step7-right">
          ...
          {url && !url2 && !url3 && !url4 && !url5 &&
            <img className="spot-img-upload-1" src={url} onError={(e) => e.target.src = 'https://imgur.com/WghnM0b.png'} alt="host spot" />
            // <img className="spot-img-upload-1" src='https://imgur.com/WghnM0b.png' />
          }

          {url && url2 && !url3 && !url4 && !url5 &&
            <div className="step7-2url">
              <img className="spot-img-upload-2" src={url} alt="host spot" />
              <img className="spot-img-upload-3" src={url2} alt="host spot" />
            </div>
          }
          {url && url2 && url3 && !url4 && !url5 &&
            <div className="step7-3url">
              <img className="spot-img-upload-2" src={url} onError={(e) => e.target.src = 'https://imgur.com/WghnM0b.png'} alt="host spot" />
              <div className="step7-3url-bottom">
                <img className="spot-img-upload-4" src={url2} onError={(e) => e.target.src = 'https://imgur.com/WghnM0b.png'} alt="host spot" />
                <img className="spot-img-upload-5" src={url3} onError={(e) => e.target.src = 'https://imgur.com/WghnM0b.png'} alt="host spot" />
              </div>
            </div>
          }
          {url && url2 && url3 && url4 && !url5 &&
            <div className="step7-3url">
              <div className="step8-3url-top">
                <img className="spot-img-upload-4" alt="host spot" src={url} onError={(e) => e.target.src = 'https://imgur.com/WghnM0b.png'} />
                <img className="spot-img-upload-5" alt="host spot" src={url2} onError={(e) => e.target.src = 'https://imgur.com/WghnM0b.png'} />
              </div>
              <div className="step7-3url-bottom">
                <img className="spot-img-upload-4" alt="host spot" src={url3} onError={(e) => e.target.src = 'https://imgur.com/WghnM0b.png'} />
                <img className="spot-img-upload-5" alt="host spot" src={url4} onError={(e) => e.target.src = 'https://imgur.com/WghnM0b.png'} />
              </div>
            </div>
          }
          {url && url2 && url3 && url4 && url5 &&
            <div className="step7-3url">
              ...
              <div className="step7-3url-bottom">
                <img className="spot-img-upload-6" alt="host spot" src={url3} onError={(e) => e.target.src = 'https://imgur.com/WghnM0b.png'} />
                <img className="spot-img-upload-7" alt="host spot" src={url4} onError={(e) => e.target.src = 'https://imgur.com/WghnM0b.png'} />
                <img className="spot-img-upload-8" alt="host spot" src={url5} onError={(e) => e.target.src = 'https://imgur.com/WghnM0b.png'} />
              </div>
            </div>
          }
